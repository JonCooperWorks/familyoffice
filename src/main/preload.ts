...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  updateReport: (
    ...
    | { path: string; usage?: { input_tokens: number; output_tokens: number } }
    | string
  > => ipcRenderer.invoke("update-report", ticker, chatHistory),

  // Report management
  getReports: (): Promise<Report[]> => ipcRenderer.invoke("get-reports"),
  ...
  getMetadata: (): Promise<any[]> => ipcRenderer.invoke("get-metadata"),

  clearMetadata: (): Promise<boolean> => ipcRenderer.invoke("clear-metadata"),
